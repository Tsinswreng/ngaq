...
class Procedure {
	...
	private _dateDif?: number //單位ˋ秒、從當前ᵗ事件ᵗ日期 至 前個ᐪ  非後個!
	...
	get dateDif(): number | undefined{
		return this._dateDif;
	}
	
	set dateDif(value: number | undefined) {
		this._dateDif = value;
	}
...
class Priority{
	...
	private _numerator:number = 3600*12 //分子
	private _defaultAddWeight:number = 80;
