...
async function testMsoc(){
	function msocPreprocess(){
		return [
			...
			{regex:/ˁr([Aaeiouə])/gm, replacement:'rˁ$1'},
	...
	let o = new Dict({
		rawObj: new DictRaw({srcPath:'D:\\Program Files\\Rime\\User_Data\\下載\\RIME_OC_collections-main\\RIME_OC_collections-main\\OC_msoegDK.dict.yaml'}),
		name:'ptl'
	})
...
...
`
	o.outputToFile('D:\\Program Files\\Rime\\User_Data\\dks.dict.yaml', 碼表頭)
}
testMsoc()
