import * as ma from 'mathjs'
export {ma}
export type BN = ma.BigNumber
export type UN = ma.BigNumber|number
...
export const a = (...num:(number|ma.BigNumber)[])=>{
	if(num.length<2){throw new Error()}
	let result= b(num[0])
	for(let i = 1; i < num.length; i++){
		result = ma.add(result,b(num[i])) as ma.BigNumber
	}
	return result
}

export const s = (...num:(number|ma.BigNumber)[])=>{
	if(num.length<2){throw new Error()}
	let result= b(num[0])
	for(let i = 1; i < num.length; i++){
		result = ma.subtract(result,b(num[i])) as ma.BigNumber
	}
	return result
}

export const m=(...num:(number|ma.BigNumber)[])=>{
	if(num.length<2){throw new Error()}
	let result= b(num[0])
	for(let i = 1; i < num.length; i++){
		result = ma.multiply(result,b(num[i])) as ma.BigNumber
	}
	return result
}
 ...
 * @returns 
 */
export const d=(...num:(number|ma.BigNumber)[])=>{
	// if(num.length<2){throw new Error()}
	// let result= b(num[0])
	// for(let i = 1; i < num.length; i++){
...
export const p=(base:UN, exponet:UN)=>{
	base = b(base)
	exponet = b(exponet)
	return ma.pow(base, exponet) as ma.BigNumber
}
