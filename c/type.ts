...
export declare var MEMFS: Emscripten.FileSystemType;
export declare var NODEFS: Emscripten.FileSystemType;
export declare var IDBFS: Emscripten.FileSystemType;

// https://emscripten.org/docs/porting/connecting_cpp_and_javascript/Interacting-with-code.html
export type StringToType<R extends any> = R extends Emscripten.JSType ? {
        number: number;
        string: string;
...
export type ReturnToType<R extends Emscripten.JSType | null> = R extends null ? null : StringToType<Exclude<R, null>>;
...
export declare function cwrap<I extends Array<Emscripten.JSType | null> | [], R extends Emscripten.JSType | null>(
    ident: string,
    returnType: R,
    argTypes: I,
...
export declare function ccall<I extends Array<Emscripten.JSType | null> | [], R extends Emscripten.JSType | null>(
    ident: string,
    returnType: R,
    argTypes: I,
    args: ArgsToType<I>,
...
export declare function setValue(ptr: number, value: any, type: Emscripten.CType, noSafe?: boolean): void;
export declare function getValue(ptr: number, type: Emscripten.CType, noSafe?: boolean): number;
...
export declare function UTF8ToString(ptr: number, maxBytesToRead?: number): string;
export declare function stringToUTF8(str: string, outPtr: number, maxBytesToRead?: number): void;
...
export declare function stringToUTF16(str: string, outPtr: number, maxBytesToRead?: number): void;
export declare function lengthBytesUTF16(str: string): number;
export declare function UTF32ToString(ptr: number): string;
export declare function stringToUTF32(str: string, outPtr: number, maxBytesToRead?: number): void;
...
export declare function writeStringToMemory(str: string, buffer: number, dontAddNull: boolean): void;
export declare function writeArrayToMemory(array: number[], buffer: number): void;
export declare function writeAsciiToMemory(str: string, buffer: number, dontAddNull: boolean): void;

export declare function addRunDependency(id: any): void;
export declare function removeRunDependency(id: any): void;

export declare function addFunction(func: (...args: any[]) => any, signature?: string): number;
export declare function removeFunction(funcPtr: number): void;

export declare var ALLOC_NORMAL: number;
export declare var ALLOC_STACK: number;
export declare var ALLOC_STATIC: number;
export declare var ALLOC_DYNAMIC: number;
export declare var ALLOC_NONE: number;
